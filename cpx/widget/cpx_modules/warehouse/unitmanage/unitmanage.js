define(function(require, exports, module) {
    ...
    var searchUrl = '/test/reim/unitmanage.json';
    ...
    var unitmanage = {
        ...
        initTable: function() {
            ...
            var columns = [
                ...
                {display: '计量单位编号', name: 'id'},
                {display: '计量单位名称', name: 'name'},
                {display: '创建时间', name: 'createdTime'},
        ...
        getSearchData: function() {
            ...
            return {
                ...
                unitName: '请输入单位名称' == $('#unitName').val() ? '' : $('#unitName').val(),
                start: $('#start').val(),
                end: $('#end').val()    
            }
        }
