define(function(require, exports, module) {
    ...
    var searchUrl = '/test/reim/reimclaimspay.json';
    ...
    var reimclaimspay = {
        ...
        initCombo: function() {
            ...
            self.promoterCombo = Business.publicCombo($('#promoter'), {
                defaultSelected: 0,
                comboType: 'employee',
        ...
        initTable: function() {
            ...
            var columns = [
                ...
                {display: '收款单位/人', name: 'beneficiary'},
                {display: '类型', name: 'expenseType'},
                {display: '审核人', name: 'endReviewer'},
                {display: '应付(元)', name: 'amountTotal', align: 'right'},
                {display: '审核状态', name: 'paymentStatus'}
        ...
        initTableEvent: function() {
            $('.grid-wrap').on('click', '.ui-icon-detail', function() {
                ...
                parent.tab.addTabItem({
                    tabid: 'reimclaims-reimclaimspaydetail',
                    text: '采购详情',
                    url: '/page/reimclaims/reimclaimspaydetail.html?random='+Math.random() 
                });        
            });
        },
        ...
        getSearchData: function() {
            var self = this;
            return {
                promoter: self.promoterCombo.getValue(),
