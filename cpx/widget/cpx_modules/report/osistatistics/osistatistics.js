define(function(require, exports, module) {
    ...
    var searchUrl = '/test/reim/osistatistics.json';
    ...
    var osistatistics = {
        ...
        initCombo: function() {
           ...
           self.storageInTypeCombo = Business.publicCombo($('#storageInType'), {
        ...
        initTable: function() {
            ...
            var columns = [
                ...
                {display: '入库类型', name: 'expenseSnTypeValue'},
                  {display: '数量', name: 'realNumber'}, 
        ...
        getSearchData: function() {
            ...
            return {
                ...
                storageInType: self.storageInTypeCombo.getValue(),
                start: $('#start').val(),
                end: $('#end').val()    
            };
        }
