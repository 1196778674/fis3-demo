define(function(require, exports, module) {
    ...
    var searchUrl = '/test/reim/osidetail.json';
    ...
    var osidetail = {
        ...
        initCombo: function() {
           ...
           self.otherTypeCombo = Business.publicCombo($('#otherType'), {
                comboType: 'otherType',
                editable: true
            });
            ...
            var columns = [
                ...
                {display: '单号', name: 'expenseSn'},    
                 {display: '单价(元)', name: 'materialPrice'},
                  ...
                  {display: '其他入库小计(元)', name: 'pCount'}, 
                  {display: '其他入库类型', name: 'expenseSnTypeValue'}    
            ];
        ...
        getSearchData: function() {
            ...
            return {
                ...
                otherType: self.otherTypeCombo.getValue(),
                start: $('#start').val(),
                end: $('#end').val()    
            };
        }
