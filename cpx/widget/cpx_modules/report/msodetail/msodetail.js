define(function(require, exports, module) {
    ...
    var searchUrl = '/test/reim/msodetail.json';
    ...
    var msodetail = {
        ...
        initCombo: function() {
           ...
           self.useDepartmentCombo = Business.publicCombo($('#useDepartment'), {
        ...
        initTable: function() {
            ...
            var columns = [
                ...
                {display: '出库单号', name: 'expenseSn'},    
                 {display: '单价(元)', name: 'materialPrice'},
 
                  {display: '数量', name: 'materialCount'}, 
                  {display: '单位', name: 'materialUnitName'},
                  {display: '小计(元)', name: 'subtotal'}, 
                  {display: '领用部门', name: 'departmentName'}    
            ];
        ...
        getSearchData: function() {
            ...
            return {
                ...
                useDepartment: self.useDepartmentCombo.getValue(),
                start: $('#start').val(),
                end: $('#end').val()    
            };
        }
