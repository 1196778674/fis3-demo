define(function(require, exports, module) {
    ...
    var searchUrl = '/test/reim/osostatistics.json';
    ...
    var osostatistics = {
        ...
        initCombo: function() {
           ...
           self.storageOutTypeCombo = Business.publicCombo($('#storageOutType'), {
        ...
        getSearchData: function() {
            ...
            return {
                ...
                storageOutType: self.storageOutTypeCombo.getValue(),
                start: $('#start').val(),
                end: $('#end').val()    
            };
        }
